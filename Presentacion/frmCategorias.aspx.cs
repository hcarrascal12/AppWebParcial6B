...
namespace Presentacion
{
    public partial class frmCategorias : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(GetType(), "InitializeDatatable", "$(document).ready(function() { $('.tblCategorias').prepend($('<thead></thead>').append($('.tblCategorias').find('tr:first'))).DataTable({language: {url: '//cdn.datatables.net/plug-ins/1.13.4/i18n/es-ES.json'}}); $('.tblCategorias thead tr th').addClass('text-center'); });", true);
        }
